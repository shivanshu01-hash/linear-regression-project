...
model = pickle.load(open(r'C:\Users\dell\OneDrive\Desktop\FSDSAI\ML_Workspace\SLR\linear_regression_model.pkl', 'rb'))
...
years_experience = st.number_input("Enter Years of Experience:", min_value=0.0, max_value=100.0)
